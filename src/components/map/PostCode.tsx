...
function PostCode () {
  ...
  // elementWrap은 HTMLDivElement 요소에 대한 참조를 가지거나 null 값을 가질 수 있는 변수가 됩니다.
  // 우편번호 검색 기능을 제공하는 Daum 우편번호찾기 API의 결과를 보여주기 위한 <div> 요소를 참조하기 위해 사용
  const elementWrap = useRef<HTMLDivElement | null>(null);

  // PostCode 컴포넌트에 index.html에 우편번호찾기 api 코드 추가
  useEffect(() => {
